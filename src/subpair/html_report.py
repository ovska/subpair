...
<p class="note">Check table rows to choose comparison pairs. Each mode starts with its top {default_count}; the pair tabs below the table open one full diagnostic at a time.</p>
